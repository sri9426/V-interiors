...
export default function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={
        floating
          ? "fixed bottom-6 right-6 inline-flex items-center gap-2 rounded-full bg-emerald-600 px-4 py-3 text-white shadow-lg hover:bg-emerald-700"
          : "inline-flex items-center gap-2 rounded-full bg-emerald-600 px-4 py-3 text-white hover:bg-emerald-700"
      }
